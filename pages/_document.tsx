  ...
  return (
    <Html lang="pt-br">
      <Head>
        ...
        <meta name="twitter:description" content="Vista inesquecível, Alta gastronomia e Staff completo para eventos corporativos, aniversários, casamentos e muito mais! Reserve seu evento no Faro Beach Club" />
        <meta name="twitter:image" content="https://farobeachclub.com.br/logo.png" />
